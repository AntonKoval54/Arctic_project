...
class MainWindow(QWidget):
    ...
    def plot_maker(self):
        ...
        # Создаем график с помощью pyqtgraph
        plot = pg.PlotWidget()

        # Добавляем линии на график
        plot.plot(df['0.5'], df['Дата'], pen='r', name='0.5')
        plot.plot(df['1.5'], df['Дата'], pen='g', name='1.5')
        plot.plot(df['2.5'], df['Дата'], pen='b', name='2.5')

        # Устанавливаем подписи осей
        plot.setLabel('bottom', 'Значение')
        plot.setLabel('left', 'Дата')
